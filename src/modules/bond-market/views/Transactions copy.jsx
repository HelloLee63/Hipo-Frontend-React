...
const Transactions = () => {
  ...
  var web3 = new Web3(RPC_HTTPS_URL);
  var abi = FinancingPoolABI;
  var address = "0x3376B3f38B2F8DeAaA0FC71aeBc5A2845178d990";
  ...
  contract.getPastEvents('RemoveLiquidity', {
      filter: {_from: '0x8B1Cd879Ca6250cd15F98653c950C25beDD6D8a9'},
      fromBlock: 0,
      toBlock: 'latest'
