...
const CompletePurchaseTransaction = () => {
      ...
      <div>
        ...
        <div className="card mb-2">
          <div className="card-body pt-3 pb-3">
            <TokenIcon tokenName={ `${pool.bondAsset.symbol} Bond` } tokenDesc={ pool.duration.description } tokenIcon={ pool.icon }/>
          </div>
        </div>
...
export default CompletePurchaseTransaction